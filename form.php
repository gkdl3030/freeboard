...
<script>
    function check_input(){
        ...
        if(!document.member.pass_confirm.value){
            alert("비밀번호확인을 입력하세요!");
            documnet.member.pass_confirm.focus();
            return;
        }
    ...
    <body>
        ...
        <ul class="join_form">
            <li>
                ...
                <sapn class="col2"><input type="text" name="id"></span>
                <span class="col3"><botton type="botton" onclick="check_id()">중복체크</botton></span>
            </li>
            <li>
